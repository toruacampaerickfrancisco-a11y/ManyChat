          ...
          <div className="lg:w-[400px] flex flex-col gap-6 justify-center">
            <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 flex flex-col gap-4">
              ...
              <a href={getInstagramLink()} target="_blank" rel="noopener noreferrer" 
                className="group flex items-center justify-center gap-3 px-6 py-3.5 bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] text-white transition-all shadow-md hover:shadow-lg rounded-xl font-bold text-md tracking-wide hover:-translate-y-1" title="Instagram">
              ...
              {/* Facebook */}
              <a href="#" className="group flex items-center justify-center gap-3 px-6 py-3.5 bg-[#1877F2] hover:bg-[#166fe5] text-white transition-all shadow-md hover:shadow-lg rounded-xl font-bold text-md tracking-wide hover:-translate-y-1" title="Facebook">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
              ...
              {/* WhatsApp */}
              <a href="#" className="group flex items-center justify-center gap-3 px-6 py-3.5 bg-[#25D366] hover:bg-[#20ba5a] text-white transition-all shadow-md hover:shadow-lg rounded-xl font-bold text-md tracking-wide hover:-translate-y-1" title="WhatsApp">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
              ...
              {/* Telegram */}
              <a href="#" className="group flex items-center justify-center gap-3 px-6 py-3.5 bg-[#229ED9] hover:bg-[#1d8fc5] text-white transition-all shadow-md hover:shadow-lg rounded-xl font-bold text-md tracking-wide hover:-translate-y-1" title="Telegram">
                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
            ...
            <div className="bg-[#1a4a49] text-white p-8 rounded-2xl shadow-xl flex flex-col gap-3">
              ...
              <p className="font-semibold">contacto@costos.com</p>
            </div>
          </div>
        </div>
      </main>
