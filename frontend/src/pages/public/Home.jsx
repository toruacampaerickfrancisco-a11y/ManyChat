          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-4xl pb-16">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href={getInstagramLink()} target="_blank" rel="noopener noreferrer" 
                className="group flex items-center justify-center w-14 h-14 bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] text-white transition-all shadow-lg hover:shadow-xl rounded-full hover:-translate-y-1" title="Instagram">
              ...
              {/* Facebook */}
              <a href="#" className="group flex items-center justify-center w-14 h-14 bg-[#1877F2] hover:bg-[#166fe5] text-white transition-all shadow-lg hover:shadow-xl rounded-full hover:-translate-y-1" title="Facebook">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
              ...
              {/* WhatsApp */}
              <a href="#" className="group flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white transition-all shadow-lg hover:shadow-xl rounded-full hover:-translate-y-1" title="WhatsApp">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
              ...
              {/* Telegram */}
              <a href="#" className="group flex items-center justify-center w-14 h-14 bg-[#229ED9] hover:bg-[#1d8fc5] text-white transition-all shadow-lg hover:shadow-xl rounded-full hover:-translate-y-1" title="Telegram">
                <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
