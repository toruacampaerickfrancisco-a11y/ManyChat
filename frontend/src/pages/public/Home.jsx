          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-4xl pb-16">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              ...
              <a href={getInstagramLink()} target="_blank" rel="noopener noreferrer" 
                className="group flex items-center justify-center text-white/80 hover:text-[#e6683c] transition-all hover:-translate-y-1 hover:scale-110" title="Instagram">
              ...
              {/* Facebook */}
              <a href="#" className="group flex items-center justify-center text-white/80 hover:text-[#1877F2] transition-all hover:-translate-y-1 hover:scale-110" title="Facebook">
                <svg viewBox="0 0 24 24" width="38" height="38" fill="currentColor">
              ...
              {/* WhatsApp */}
              <a href="#" className="group flex items-center justify-center text-white/80 hover:text-[#25D366] transition-all hover:-translate-y-1 hover:scale-110" title="WhatsApp">
                <svg viewBox="0 0 24 24" width="38" height="38" fill="currentColor">
              ...
              {/* Telegram */}
              <a href="#" className="group flex items-center justify-center text-white/80 hover:text-[#229ED9] transition-all hover:-translate-y-1 hover:scale-110" title="Telegram">
                <svg viewBox="0 0 24 24" width="38" height="38" fill="currentColor">
            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-4 px-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-12 md:gap-20">
                ...
                <img 
                  src="/cfe.png" 
                  alt="CFE" 
                  className="h-10 md:h-14 opacity-50 hover:opacity-100 transition-all drop-shadow-md grayscale hover:grayscale-0 object-contain"
                />
                
                {/* Texto OPUS estilizado como logo */}
                <div className="opacity-50 hover:opacity-100 transition-all grayscale hover:grayscale-0 flex items-center cursor-default">
                  <span className="text-2xl md:text-4xl font-black text-white tracking-tighter drop-shadow-md">
                    OPUS
                  </span>
                </div>
                ...
                <div className="opacity-50 hover:opacity-100 transition-all grayscale hover:grayscale-0 flex items-center cursor-default">
                  <span className="text-2xl md:text-4xl font-bold text-white tracking-[0.2em] drop-shadow-md">
                    NEODATA
                  </span>
                </div>
              </div>
        ...
        <section className="py-24 px-6 bg-white">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
            <div className="w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-[6px] border-[#1a4a49]/20 shadow-2xl flex-shrink-0 relative group">
              <img src="/francisco_gardea.png" alt="Ing. Francisco Gardea - Capacitador" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
            </div>
            <div>
              <h2 className="text-4xl font-bold text-[#1a4a49] mb-2">Conoce a tu Capacitador</h2>
              <h4 className="text-2xl text-[#c0392b] font-bold mb-6">Ing. Francisco Ramón Gardea</h4>
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                Con más de 13 años de trayectoria profesional como Ingeniero Eléctrico y Coordinador de Licitaciones, me especializo en el análisis de precios unitarios, cálculo de FASAR e indirectos, y estructuración de presupuestos con software líder como <strong>OPUS</strong> y <strong>Neodata</strong>. Mi experiencia destaca en la preparación técnica y económica para concursos de licitación de la Comisión Federal de Electricidad (<strong>CFE</strong>), habiendo coordinado la adjudicación de múltiples proyectos de infraestructura de gran escala en México. Mi meta es transmitirte herramientas prácticas y normativas clave para asegurar que tus propuestas sean competitivas y exitosas.
              </p>
              <div className="flex flex-wrap gap-4">
                <span className="px-5 py-2.5 bg-gray-100 rounded-full text-sm font-bold text-[#1a4a49] shadow-sm">Experto en OPUS & Neodata</span>
                <span className="px-5 py-2.5 bg-gray-100 rounded-full text-sm font-bold text-[#1a4a49] shadow-sm">Licitaciones CFE</span>
                <span className="px-5 py-2.5 bg-gray-100 rounded-full text-sm font-bold text-[#1a4a49] shadow-sm">Certificación EC-0219 & EC-1124</span>
              </div>
            </div>
          </div>
        </section>
