          ...
          <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/60 to-transparent pt-12 pb-6 z-20">
            <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-4 px-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-10 md:gap-16">
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/profile.php?id=61591801231145" target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 text-white hover:text-[#1877F2] transition-all drop-shadow-md flex items-center justify-center" title="Facebook">
                  <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-10 md:h-10" fill="currentColor">
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/526624745958?text=Hola%20Clipop,%20me%20gustaría%20recibir%20información" target="_blank" rel="noopener noreferrer" className="opacity-50 hover:opacity-100 text-white hover:text-[#25D366] transition-all drop-shadow-md flex items-center justify-center" title="WhatsApp">
                  <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-10 md:h-10" fill="currentColor">
